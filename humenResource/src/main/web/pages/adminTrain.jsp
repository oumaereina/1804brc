...
<div>
    <form action="train/addTrain" method="post">
        <ul>
            <li>发布培训信息</li>
            <li>主题<input name="t_other" class="tr" msg="主题"></li>
            <li>地点<input name="t_add" class="tr" msg="地点"></li>
            <li>开始时间<input name="t_start" type="date" class="tr" msg="开始时间"></li>
            <li>结束时间<input name="t_end" type="date" class="tr" msg="结束时间"></li>
            <li>内容<input name="t_content" class="tr" msg="内容"></li>
